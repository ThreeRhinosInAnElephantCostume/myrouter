...
set -Ux WIFI_ROOT_IP_MASK 192.168.1.1/24
set -Ux WIFI_ROOT_IP 192.168.1.1

set -Ux WIFI_NET_IP_MASK 192.168.1.0/24
set -Ux WIFI_NET_IP 192.168.1.0
set -Ux WIFI_NET_MASK 24
