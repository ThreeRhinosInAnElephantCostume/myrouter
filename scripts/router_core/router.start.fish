...
print_exec ip route add table local $WIFI_NET_IP_MASK via $WIFI_ROOT_IP dev $WIFI_INTERFACE
print_exec ip route add table local $LAN_NET_IP_MASK via $LAN_ROOT_IP dev $LAN_INTERFACE

print_success "Router startup complete!"